# DOOM-Game-in-one-big-HTML-file

Welcome to that DOOM game in one big html file, an open sourced first-person shooter (FPS) game. 
This is the original code of the game Doomsday Survival on crazygames.io, which will be updated in two months.

## Features

*   **First-Person Shooter Gameplay**: Move, look around, and shoot zombies in real-time.
...
| **1-7 Keys** | Switch between weapons you own |
| **TAB** | Open/Close the Store |
| **L** | Open/Close the Leaderboard |
| **T** | Toggle Flashlight (ON/OFF) |
| **G** | Throw a Grenade |
| **H** | Use a Health Pack |
| **A** | Use Armor Kit |
| **M** | Show Controls Help |
